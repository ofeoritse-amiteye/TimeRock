            ...
            <div className="space-y-4 text-left w-full max-w-xs">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1">
                  ...
                  <a href="mailto:info@timerock.com" className="text-white hover:text-blue-400 transition-colors">info@timerock.com</a>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1">
                  ...
                  <a href="tel:09122072401" className="text-white hover:text-purple-400 transition-colors">+1 (234) 567-890</a>
                </div>
              </div>
            </div>
          </div>
